...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/axios/lib/axios.js [app-client] (ecmascript)"); // Still need this for the signin call since it doesn't require auth yet
;
...
function SignIn() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('http://localhost:8000/auth/login', {
                email,
                password
            });
...
_s(SignIn, "BI0qIM2PVJu6iW9soyLELfW+Wmk=", false, function() {
    return [
